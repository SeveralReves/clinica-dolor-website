  ...
  <div class="container">
    <div class="footer__top">
      ...
      <div class="footer__top--column">
        ...
        <div class="footer__nav">
          <div class="footer__address">
            <i class="bx bx-map"></i>
            <address>Calle Plaza nro 34, Frente a Malariologia, San Fernando Estado Apure</address>
          </div>

          <a href="mailto:clinicadeldolorapure@gmail.com" class="footer__address">
            <i class="bx bx-envelope"></i>
            <span>clinicadeldolorapure@gmail.com</span>
          </a>
          <a href="tel:+582473413436" class="footer__address">
            <i class="bx bx-phone"></i>
            <span>+58 247 3413436</span>
          </a>
          <div class="footer__socials">
            ...
            <a href="https://www.instagram.com/clinicadeldolorapure/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="icon">
              {{-- Instagram --}}
            ...
            <a href="https://api.whatsapp.com/send?phone=584142204034" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" class="icon">
              {{-- WhatsApp --}}
              <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
      ...
      <div class="footer__top--column">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d247.0014620832668!2d-67.47940694775558!3d7.892621137508139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e7886d3bec2156d%3A0x56805430ec2f3704!2s34%20Calle%20Pl.%2C%20San%20Fernando%20de%20Apure%207001%2C%20Apure!5e0!3m2!1ses!2sve!4v1766217633592!5m2!1ses!2sve" width="100%" height="150" style="border:0;border-radius: 20px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
