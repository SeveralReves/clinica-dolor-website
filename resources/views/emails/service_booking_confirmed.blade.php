...
<head>
  ...
  <title>Tu reserva fue agendada</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#16a34a;padding:36px 40px;text-align:center;">
              ...
              <h1 style="margin:10px 0 4px;font-size:24px;color:#ffffff;font-weight:700;">¡Tu reserva fue agendada!</h1>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
                Hola <strong>{{ $booking->patient->name }}</strong>, tu reserva ha sido registrada con éxito. A continuación encontrarás el resumen:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:14px 20px;text-align:center;">
                    ...
                    <p style="margin:6px 0 0;font-size:26px;font-weight:700;color:#16a34a;letter-spacing:0.06em;">{{ $booking->reference_id }}</p>
                    <p style="margin:4px 0 0;font-size:12px;color:#6b7280;">Guarda este código para consultar el estado de tu reserva.</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;margin-bottom:28px;">
                <tr style="background:#f9fafb;">
                  <td style="padding:12px 20px;font-size:12px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.06em;width:40%;border-bottom:1px solid #e5e7eb;">Servicio</td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td align="center">
                    <a href="{{ url('/reservar-servicio/gracias/' . $booking->reference_id) }}"
