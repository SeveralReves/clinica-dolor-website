        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#16a34a;padding:32px 40px;text-align:center;">
              ...
              <h1 style="margin:8px 0 0;font-size:22px;color:#ffffff;font-weight:700;">Nueva cita agendada</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
                Se ha registrado una nueva cita. A continuación encontrarás los detalles:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:14px 20px;">
                    ...
                    <p style="margin:4px 0 0;font-size:20px;font-weight:700;color:#16a34a;letter-spacing:0.05em;">{{ $appointment->reference_id }}</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;margin-bottom:28px;">
                <tr style="background:#f9fafb;">
                  ...
                  <td style="padding:12px 20px;font-size:14px;color:#111827;border-bottom:1px solid #e5e7eb;">{{ $appointment->patient->name }}</td>
                </tr>
                <tr>
                  ...
                  <td style="padding:12px 20px;font-size:14px;color:#111827;border-bottom:1px solid #e5e7eb;">{{ $appointment->patient->email }}</td>
                </tr>
                <tr style="background:#f9fafb;">
                  ...
                  <td style="padding:12px 20px;font-size:14px;color:#111827;border-bottom:1px solid #e5e7eb;">{{ $appointment->patient->phone }}</td>
                </tr>
                <tr>
                  <td style="padding:12px 20px;font-size:12px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.06em;border-bottom:1px solid #e5e7eb;">Especialista</td>
                ...
                <tr>
                  <td style="padding:12px 20px;font-size:12px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.06em;{{ $appointment->reason ? 'border-bottom:1px solid #e5e7eb;' : '' }}">Hora</td>
                  <td style="padding:12px 20px;font-size:14px;color:#111827;{{ $appointment->reason ? 'border-bottom:1px solid #e5e7eb;' : '' }}">{{ \Carbon\Carbon::parse($appointment->hour)->format('g:i A') }}</td>
                </tr>
                @if($appointment->reason)
                <tr style="background:#f9fafb;">
                  <td style="padding:12px 20px;font-size:12px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.06em;">Motivo</td>
                  <td style="padding:12px 20px;font-size:14px;color:#111827;">{{ $appointment->reason }}</td>
                </tr>
                @endif
              </table>
